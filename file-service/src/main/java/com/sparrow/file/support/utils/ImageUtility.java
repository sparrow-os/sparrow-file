...
public class ImageUtility {
    ...
    public static void makeThumbnail(String srcImagePath, String descImagePath,
        ...
        // 目标图文件对象
        Asserts.isTrue(srcImagePath.equals(descImagePath), FileError.UPLOAD_SRC_DESC_PATH_REPEAT);
        ...
        try {
            ...
            if (srcImage == null) {
                throw new BusinessException(FileError.FILE_CAN_NOT_READ);
            }
 ...
 */
     ...
     * 获取当前实体中的数据的ID列表
     */
    public static List<Long> getImageList(POJO entity) {
